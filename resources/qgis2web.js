...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [38.844803, -27.668015, 55.401447, -12.929163], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'IGNF:WGS84GEO',
            //extent: [43.360000, -25.153666, 50.250000, -12.350000],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([38.844803, -27.668015, 55.401447, -12.929163], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CURRENT AND PLANNED OBSERVATION NETWORK</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (160 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapping established as part of efforts to upgrade weather stations data<br />Sources:<br />- GBON Nation contribution plan of Madagascar<br />- SOFF project documents<br />Feb 2026';
            }
